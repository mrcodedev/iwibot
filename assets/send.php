<?php 
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['message']) && isset($_POST['company']) && isset($_POST['tel']))
{
     ...
     if (empty($name) || empty($email) || empty($mensaje) || empty($company) || empty($tel)) 
     { 
          echo "emptyone"; 
     }  
     else 
